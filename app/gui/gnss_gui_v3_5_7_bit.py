...
class GNSSMainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("GNSS Processing GUI v3.5.8")
        ...
        self.log_model = ProcessingLog(version="0.3.5.8")
    ...
    def choose_file(self):
        ...
        self.log_model.version = "0.3.5.8"
        self.log_text.clear()
    ...
    def _collect_filter_params(self) -> dict:
        return {
            "version": "3.5.8        return df_valid.loc[mask].copy()",
            "outlier": {
